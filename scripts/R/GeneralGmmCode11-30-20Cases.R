...
# Read Primary Data                                                                                                  #
                                                                                                                     #
full.dta <- read.csv(file="C:/Users/janin/Downloads/daily_raw_input.csv")                                                                     # Read data from pgmm_input_recalc_totals.csv file
...
#  out.dta[j,16,i] - 7 Day Persistance Effect                                                                        #
                                                                                                                     #
    ibeg <- first.date + 45                                                                                          # First date for constructing of the surveillance table
...
# -- United States                                                                                                   #
    ...
    dates <- sort(unique(dta$Date))                                                                                  # List of dates in the dataset
    last.date <- dates[length(dates)]                                                                                # End of period for analysis
    first.date <- dates[length(dates)-60]
# Create test values to see that the country can be added                                                            #
