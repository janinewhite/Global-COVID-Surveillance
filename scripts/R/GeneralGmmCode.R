...
# Read Primary Data                                                                                                  #
                                                                                                                     #
full.dta <- read.csv(file="pgmm_input_recalc_totals.csv")                                                            # Read data from pgmm_input_recalc_totals.csv file
...
while(n.region <= length(regions)) {                                                                                 # Loop Over Regions
  if(n.region != 6) {                                                                                                # Different setup for North America - Canada and the United States
